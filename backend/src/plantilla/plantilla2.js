...
.td1{
	background:#1890FF;background-color:#1890FF; color:#FFFFFF;
	text-align: left
}
.td3{
	text-align: left
									...
									<table cellpadding="0" cellspacing="0">
										<tbody>
											<tr>
												<td></td>
												<td>
													<table width="100%" border="0" cellspacing="0" cellpadding="0" style="direction:ltr;padding-bottom:7px;font-family:Roboto-Regular,Helvetica,Arial,sans-serif;">
													<tbody>
													<tr><td align="center" style="font-weight: bold; font-size: 16px; color: #FFF; text-transform: uppercase; text-align:center"><img src="https://www.pavas.com.co/img/logoPavasStay.png" style="height:50px"></td>
